...
inputSpec: /Users/zero/Documents/git/signwell/signwell-sdk-generator/.cache/prepared/csharp-openapi.yaml
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{17AF1977-23AC-49D6-A36A-02471E1E8364}'
...
using SignWell.Sdk.Api;
using SignWell.Sdk.Client;
using SignWell.Sdk.Model;
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IApiApplicationApi>();
            IDeleteApiApplicationApiResponse apiResponse = await api.DeleteApiApplicationAsync("todo");
...
## Api Information
- appName: SignWell Developer API
- appVersion: v1
- appDescription: API for creating, managing, and tracking electronic signature workflows.
